# Mininal html-fund-me-dApp (For in-house Agulite dApp team tutorial)
...
```
git clone https://github.com/M-Marcel/fund-me-dApp
cd fund-me-dApp
```
...
```
git clone https://github.com/M-Marcel/hardhat-fund-me-smart-contract
cd hardhat-fund-me-smart-contract
yarn
yarn hardhat node
```
...
ETH/BNB/Polygon/Avalanche/etc Address: 0x39d366c9D9A35BB0A01a27AF1e817Ee96b11d820
